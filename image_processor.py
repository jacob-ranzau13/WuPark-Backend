...
ROBOFLOW_WORKFLOW_URL = f"https://serverless.roboflow.com/workflows/{ROBOFLOW_WORKSPACE}/{ROBOFLOW_WORKFLOW_ID}"
...
def process_image_stream(event, context):
    ...
    for record in event['Records']:
        ...
        try:
            ...
            image_b64 = new_image.get('image', {}).get('B') or new_image.get('image', {}).get('S')
            if not image_b64:
